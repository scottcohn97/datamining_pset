...
sclass65amg <- sclass %>% filter(trim == "65 AMG")
...
sclass65amg_split <- initial_split(sclass65amg, prop = 0.6, strata = price)
...
kp1 <- sclass350_results %>% 
  ...
  mutate(highlight = if_else(neighbors == 6, "h", "l")) %>% 
  ggplot() + 
