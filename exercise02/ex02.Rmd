...
# print col sums
as.tibble(pred_sums, .name_repair = "unique") %>% 
  kable(col.names = make.unique(c(rep("v", 21)), sep = "")[2:21],
      caption = "Sum of predicted")
```

Now we can compare that with the actual number.
...
TODO just make these one table of predicted v actual by fold.
