...
```{r house_clean, eval=FALSE, include=FALSE}
# DO NOT RUN
...
housing <-
  ...
  mutate(
    # to these columns... 
    across(c(totalBedrooms, totalRooms, population, housingMedianAge, medianIncome), 
           # ...apply this function
           range_standardize)
    )
```
...
Let's look at the predicted values on a map:
